/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 690fee16ecbfc68896e1fb4d3d96eb42)
// Runtime types generated with workerd@1.20251011.0 2025-08-03 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server/index");
		durableNamespaces: "PomaAgent";
	}
	interface Env {
		MODEL_NAME: "gpt-5-nano";
		OPENAI_API_KEY: string;
		CF_AIG_TOKEN: string;
		PomaAgent: DurableObjectNamespace<import("./src/server/index").PomaAgent>;
		AI: Ai;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MODEL_NAME" | "OPENAI_API_KEY" | "CF_AIG_TOKEN">> {}
}
